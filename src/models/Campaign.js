...
class Campaign {
    ...
    static create(data) {
        ...
        const stmt = db.prepare(`
            INSERT INTO campaigns (
                ...
                media_url, media_caption, ptt, message_delay_min, message_delay_max, created_by,
    ...
    static update(id, updates) {
        ...
        const allowedFields = [
            ...
            'message_type', 'media_url', 'media_caption', 'ptt', 'message_delay_min', 'message_delay_max',
