      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b pb-8">
        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-foreground">{userName}</h1>
            <p className="text-muted-foreground text-[11px] font-medium flex items-center justify-center sm:justify-start gap-2">
              <Mail className="h-3 w-3" /> {userEmail}
            </p>
            <div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
              <Badge variant="secondary" className="uppercase text-[9px] font-bold px-1.5 h-4 tracking-tighter">{userRole}</Badge>
              {user?.whatsapp_number && (
                <Badge variant="outline" className="text-[9px] font-bold border-primary/20 text-primary bg-primary/5 px-1.5 h-4 tracking-tighter">
                  <Smartphone className="h-2.5 w-2.5 mr-1" /> {user.whatsapp_number}
                </Badge>
              )}
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <Button variant="outline" size="sm" className="w-full sm:w-auto h-8 text-[11px] font-bold uppercase tracking-widest" onClick={() => signOut(() => router.push("/login"))}>
            <LogOut className="h-3.5 w-3.5 mr-1.5" /> Déconnexion
          </Button>
          <Button size="sm" className="w-full sm:w-auto h-8 text-[11px] font-bold uppercase tracking-widest shadow-none" onClick={handleUpdate} disabled={isSaving}>
