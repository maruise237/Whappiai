...
export function RegisterForm() {
    ...
    return (
      <form onSubmit={handleVerify} className="space-y-6 flex flex-col items-center">
        ...
        <div className="flex gap-2 w-full">
          <button
            type="button"
            className="flex-1 h-12 rounded-xl bg-background border border-input text-foreground hover:bg-muted"
          ...
          <Button
            type="submit"
            className="flex-[2] h-12 bg-green-500 hover:bg-green-600 dark:bg-green-500
              dark:hover:bg-green-400 text-white dark:text-black font-bold text-[15px]
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <Button
        type="submit"
        className="w-full h-12 bg-green-500 hover:bg-green-600 dark:bg-green-500
          dark:hover:bg-green-400 text-white dark:text-black font-bold text-[15px]
