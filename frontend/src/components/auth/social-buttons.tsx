  ...
  return (
    <div className="grid grid-cols-2 gap-3 mb-6">
      <Button 
        ...
        className="h-11 bg-white text-black hover:bg-zinc-200 border-none font-semibold text-xs"
      >
      ...
      <Button 
        variant="outline" 
        disabled
        className="h-11 bg-zinc-800 text-white border-zinc-700 hover:bg-zinc-700 font-semibold text-xs opacity-50 cursor-not-allowed"
      >
