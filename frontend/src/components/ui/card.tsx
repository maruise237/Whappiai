...
function Card({
  ...
  return (
    <div
      ...
      className={cn("ring-foreground/10 bg-card text-card-foreground overflow-hidden rounded-lg text-sm shadow-xs ring-1 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg group/card flex flex-col transition-all duration-200", className)}
      {...props}
    />
  )
}
