    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20 pb-16 lg:pt-32">
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto space-y-8">
          ...
          >
            Whappi automatise l&apos;accueil, la modération et les rappels dans vos groupes WhatsApp. Fait pour les admins africains qui gèrent des communautés actives, sans API Meta officielle ni configuration compliquée.
          </motion.p>
