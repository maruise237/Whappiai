      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">Le co-admin WhatsApp pour garder vos groupes propres, utiles et faciles à gérer.</p>
            {/* System Status */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/20 border border-border">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Bot de modération actif</span>
            </div>
          </div>
        ...
        >
          <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Whappi by KAMTECH IA. Tous droits réservés.</p>
