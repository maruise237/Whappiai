...
export function LogoMarquee() {
  ...
  return (
    <section ref={ref} className="py-10 lg:py-16 overflow-hidden">
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <p className="text-sm text-muted-foreground uppercase tracking-wider font-medium">Intégrations natives et outils compatibles</p>
      </motion.div>
